...
const testFloatsWithCurrency: [number, string][] = [
  [0.0, 'صفر جنيه مصري فقط لا غير'],
  [0.04, 'صفر جنيه مصري و أربعة قروش فقط لا غير'],
  [0.4, 'صفر جنيه مصري و أربعون قرش فقط لا غير'],
  [0.63, 'صفر جنيه مصري و ثلاثة و ستون قرش فقط لا غير'],
  [0.999, 'جنيه واحد فقط لا غير'],
  [1, 'جنيه واحد فقط لا غير'],
  [2, 'جنيهان فقط لا غير'],
  [3, 'ثلاثة جنيهات فقط لا غير'],
  [37.06, 'سبعة و ثلاثون جنيه مصري و ستة قروش فقط لا غير'],
  [37.68, 'سبعة و ثلاثون جنيه مصري و ثمانية و ستون قرش فقط لا غير'],
  [100, 'مائة جنيه مصري فقط لا غير'],
  [500.25, 'خمسمائة جنيه مصري و خمسة و عشرون قرش فقط لا غير'],
];
...
describe('Test Floats with options = { currency: true, ignoreZeroCurrency: true }', () => {
  ...
  testFloatsWithCurrencyAndIgnoreZeroCurrency.map((row, i) => {
    ...
    if (row[0] > 0 && row[0] < 1) {
      row[1] = (row[1] as string).replace('صفر جنيه مصري و ', '');
    }
  });
