...
const testFloatsWithCurrency: [number, string][] = [
  ...
  [0.04, 'صفر درهم و أربعة سنتيمات فقط لا غير'],
  [0.4, 'صفر درهم و أربعون سنتيم فقط لا غير'],
  [0.63, 'صفر درهم و ثلاثة و ستون سنتيم فقط لا غير'],
  [0.973, 'صفر درهم و سبعة و تسعون سنتيم فقط لا غير'],
  [0.999, 'درهم واحد فقط لا غير'],
  [1, 'درهم واحد فقط لا غير'],
  [2, 'درهمان فقط لا غير'],
  [3, 'ثلاثة دراهم فقط لا غير'],
  [37.06, 'سبعة و ثلاثون درهم و ستة سنتيمات فقط لا غير'],
  [37.68, 'سبعة و ثلاثون درهم و ثمانية و ستون سنتيم فقط لا غير'],
  [37.683, 'سبعة و ثلاثون درهم و ثمانية و ستون سنتيم فقط لا غير'],
  [100, 'مائة درهم فقط لا غير'],
  [500.25, 'خمسمائة درهم و خمسة و عشرون سنتيم فقط لا غير'],
  [1000.5, 'ألف درهم و خمسون سنتيم فقط لا غير'],
];
  ...
  const testFloatsWithCurrencyAndIgnoreDecimal = cloneDeep(testFloatsWithCurrency).map((row) => {
    ...
    switch (true) {
      ...
      case value >= 1 && value < 2:
        return [value, 'درهم واحد فقط لا غير'];
      case value >= 2 && value < 3:
        return [value, 'درهمان فقط لا غير'];
      case value >= 3 && value < 4:
        return [value, 'ثلاثة دراهم فقط لا غير'];
      case value >= 37 && value < 38:
        return [value, 'سبعة و ثلاثون درهم فقط لا غير'];
      case value >= 100 && value < 101:
        return [value, 'مائة درهم فقط لا غير'];
