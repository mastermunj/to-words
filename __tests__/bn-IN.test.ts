...
describe('Test with options = { currency: true, includeZeroFractional: true }', () => {
  const testIncludeZeroFractional: [number | string, string][] = [
    [123, `এক শত তেইশ টাকা`],
    ['123', `এক শত তেইশ টাকা`],
    ['123.0', `এক শত তেইশ টাকা এবং শূন্য পয়সা`],
    ['123.00', `এক শত তেইশ টাকা এবং শূন্য পয়সা`],
    ['0.00', `শূন্য টাকা এবং শূন্য পয়সা`],
    ['-123.00', `ঋণ এক শত তেইশ টাকা এবং শূন্য পয়সা`],
...
const testFractionStyleBnIN: [number, string][] = [
...
describe("Test Floats with options = { decimalStyle: 'fraction' }", () => {
  test.concurrent.each(testFractionStyleBnIN)('convert %d => %s', (input, expected) => {
