...
import deAt from '../src/locales/de-AT.js';
import {
  ToWords as LocaleToWords,
  toWords as localeToWords,
  toOrdinal as localeToOrdinal,
  toCurrency as localeToCurrency,
} from '../src/locales/de-AT.js';

const localeCode = 'de-AT';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toWords.getLocaleClass()).toBe(deAt);
  });
...
describe('Test with options = { currency: true, includeZeroFractional: true }', () => {
  const testIncludeZeroFractional: [number | string, string][] = [
    [123, `Hundert Dreiundzwanzig Euro`],
    ['123', `Hundert Dreiundzwanzig Euro`],
    ['123.0', `Hundert Dreiundzwanzig Euro Und Null Cent`],
    ['123.00', `Hundert Dreiundzwanzig Euro Und Null Cent`],
    ['0.00', `Null Euro Und Null Cent`],
    ['-123.00', `Minus Hundert Dreiundzwanzig Euro Und Null Cent`],
...
// ============================================================
// COMPREHENSIVE TEST ADDITIONS FOR de-AT
// ============================================================
...
// Invalid Input Tests
describe('Test Invalid Inputs for de-AT', () => {
  test('throws for NaN', () => {
...
const testFractionStyleDeAT: [number, string][] = [
...
describe("Test Floats with options = { decimalStyle: 'fraction' }", () => {
  test.concurrent.each(testFractionStyleDeAT)('convert %d => %s', (input, expected) => {
