...
describe('Test with options = { currency: true, includeZeroFractional: true }', () => {
  const testIncludeZeroFractional: [number | string, string][] = [
    ...
    ['123', `One Hundred Twenty Three Dirhams Only`],
    ['123.0', `One Hundred Twenty Three Dirhams And Zero Fils Only`],
    ['123.00', `One Hundred Twenty Three Dirhams And Zero Fils Only`],
    ['0.00', `Zero Dirhams And Zero Fils Only`],
    ['-123.00', `Minus One Hundred Twenty Three Dirhams And Zero Fils Only`],
...
const testFractionStyleEnAE: [number, string][] = [
...
describe("Test Floats with options = { decimalStyle: 'fraction' }", () => {
  test.concurrent.each(testFractionStyleEnAE)('convert %d => %s', (input, expected) => {
