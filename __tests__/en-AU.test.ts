...
describe('Test with options = { currency: true, includeZeroFractional: true }', () => {
  const testIncludeZeroFractional: [number | string, string][] = [
    [123, `One Hundred Twenty Three Australian Dollars Only`],
    ['123', `One Hundred Twenty Three Australian Dollars Only`],
    ['123.0', `One Hundred Twenty Three Australian Dollars and Zero Cents Only`],
    ['123.00', `One Hundred Twenty Three Australian Dollars and Zero Cents Only`],
    ['0.00', `Zero Australian Dollars and Zero Cents Only`],
    ['-123.00', `Minus One Hundred Twenty Three Australian Dollars and Zero Cents Only`],
...
describe('Test Zero Variants', () => {
  ...
  test('convert 0 with currency => Zero Australian Dollars Only', () => {
    expect(toWords.convert(0, { currency: true })).toBe('Zero Australian Dollars Only');
  });
});
...
const testFractionStyleEnAU: [number, string][] = [
...
describe("Test Floats with options = { decimalStyle: 'fraction' }", () => {
  test.concurrent.each(testFractionStyleEnAU)('convert %d => %s', (input, expected) => {
