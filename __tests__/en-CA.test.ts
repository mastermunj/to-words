...
describe('Test with options = { currency: true, includeZeroFractional: true }', () => {
  const testIncludeZeroFractional: [number | string, string][] = [
    [123, `One Hundred Twenty Three Canadian Dollars Only`],
    ['123', `One Hundred Twenty Three Canadian Dollars Only`],
    ['123.0', `One Hundred Twenty Three Canadian Dollars And Zero Cents Only`],
    ['123.00', `One Hundred Twenty Three Canadian Dollars And Zero Cents Only`],
    ['0.00', `Zero Canadian Dollars And Zero Cents Only`],
    ['-123.00', `Minus One Hundred Twenty Three Canadian Dollars And Zero Cents Only`],
...
const testFractionStyleEnCA: [number, string][] = [
...
describe("Test Floats with options = { decimalStyle: 'fraction' }", () => {
  test.concurrent.each(testFractionStyleEnCA)('convert %d => %s', (input, expected) => {
