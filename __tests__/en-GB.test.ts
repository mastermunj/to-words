...
describe('Test with options = { currency: true, includeZeroFractional: true }', () => {
  const testIncludeZeroFractional: [number | string, string][] = [
    [123, `One Hundred Twenty Three Pounds Only`],
    ['123', `One Hundred Twenty Three Pounds Only`],
    ['123.0', `One Hundred Twenty Three Pounds And Zero Pence Only`],
    ['123.00', `One Hundred Twenty Three Pounds And Zero Pence Only`],
    ['0.00', `Zero Pounds And Zero Pence Only`],
    ['-123.00', `Minus One Hundred Twenty Three Pounds And Zero Pence Only`],
...
const testFractionStyleEnGB: [number, string][] = [
...
describe("Test Floats with options = { decimalStyle: 'fraction' }", () => {
  test.concurrent.each(testFractionStyleEnGB)('convert %d => %s', (input, expected) => {
