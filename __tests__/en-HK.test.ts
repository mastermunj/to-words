...
import enUs from '../src/locales/en-HK.js';
import {
  ToWords as LocaleToWords,
  toWords as localeToWords,
  toOrdinal as localeToOrdinal,
  toCurrency as localeToCurrency,
} from '../src/locales/en-HK.js';

const localeCode = 'en-HK';
...
// ============================================================
// COMPREHENSIVE TEST ADDITIONS FOR en-HK
// ============================================================
...
// Invalid Input Tests
describe('Test Invalid Inputs for en-HK', () => {
  test('throws for NaN', () => {
...
const testFractionStyleEnHK: [number, string][] = [
...
describe("Test Floats with options = { decimalStyle: 'fraction' }", () => {
  test.concurrent.each(testFractionStyleEnHK)('convert %d => %s', (input, expected) => {
