...
import enUs from '../src/locales/en-JM.js';
import {
  ToWords as LocaleToWords,
  toWords as localeToWords,
  toOrdinal as localeToOrdinal,
  toCurrency as localeToCurrency,
} from '../src/locales/en-JM.js';

const localeCode = 'en-JM';
...
// ============================================================
// COMPREHENSIVE TEST ADDITIONS FOR en-JM
// ============================================================
...
// Invalid Input Tests
describe('Test Invalid Inputs for en-JM', () => {
  test('throws for NaN', () => {
...
const testFractionStyleEnJM: [number, string][] = [
...
describe("Test Floats with options = { decimalStyle: 'fraction' }", () => {
  test.concurrent.each(testFractionStyleEnJM)('convert %d => %s', (input, expected) => {
