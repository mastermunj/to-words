...
describe('Test with options = { currency: true, includeZeroFractional: true }', () => {
  const testIncludeZeroFractional: [number | string, string][] = [
    [123, `One Hundred Twenty Three Ringgit Only`],
    ['123', `One Hundred Twenty Three Ringgit Only`],
    ['123.0', `One Hundred Twenty Three Ringgit And Zero Sen Only`],
    ['123.00', `One Hundred Twenty Three Ringgit And Zero Sen Only`],
    ['0.00', `Zero Ringgit And Zero Sen Only`],
    ['-123.00', `Minus One Hundred Twenty Three Ringgit And Zero Sen Only`],
...
const testFractionStyleEnMY: [number, string][] = [
...
describe("Test Floats with options = { decimalStyle: 'fraction' }", () => {
  test.concurrent.each(testFractionStyleEnMY)('convert %d => %s', (input, expected) => {
