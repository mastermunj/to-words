...
describe('Test with options = { currency: true, includeZeroFractional: true }', () => {
  const testIncludeZeroFractional: [number | string, string][] = [
    [123, `One Hundred Twenty Three Naira Only`],
    ['123', `One Hundred Twenty Three Naira Only`],
    ['123.0', `One Hundred Twenty Three Naira And Zero Kobo Only`],
    ['123.00', `One Hundred Twenty Three Naira And Zero Kobo Only`],
    ['0.00', `Zero Naira And Zero Kobo Only`],
    ['-123.00', `Minus One Hundred Twenty Three Naira And Zero Kobo Only`],
...
describe('Test Zero Variants', () => {
  ...
  test('convert 0 with currency => Zero Naira Only', () => {
    expect(toWords.convert(0, { currency: true })).toBe('Zero Naira Only');
  });
});
...
const testFractionStyleEnNG: [number, string][] = [
...
describe("Test Floats with options = { decimalStyle: 'fraction' }", () => {
  test.concurrent.each(testFractionStyleEnNG)('convert %d => %s', (input, expected) => {
