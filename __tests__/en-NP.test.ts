...
describe('Test with options = { currency: true, includeZeroFractional: true }', () => {
  const testIncludeZeroFractional: [number | string, string][] = [
    ...
    ['123', `One Hundred Twenty Three Rupees Only`],
    ['123.0', `One Hundred Twenty Three Rupees And Zero Paisa Only`],
    ['123.00', `One Hundred Twenty Three Rupees And Zero Paisa Only`],
    ['0.00', `Zero Rupees And Zero Paisa Only`],
    ['-123.00', `Minus One Hundred Twenty Three Rupees And Zero Paisa Only`],
...
const testFractionStyleEnNP: [number, string][] = [
...
describe("Test Floats with options = { decimalStyle: 'fraction' }", () => {
  test.concurrent.each(testFractionStyleEnNP)('convert %d => %s', (input, expected) => {
