...
describe('Test with options = { currency: true, includeZeroFractional: true }', () => {
  const testIncludeZeroFractional: [number | string, string][] = [
    [123, `One Hundred Twenty Three New Zealand Dollars Only`],
    ['123', `One Hundred Twenty Three New Zealand Dollars Only`],
    ['123.0', `One Hundred Twenty Three New Zealand Dollars and Zero Cents Only`],
    ['123.00', `One Hundred Twenty Three New Zealand Dollars and Zero Cents Only`],
    ['0.00', `Zero New Zealand Dollars and Zero Cents Only`],
    ['-123.00', `Minus One Hundred Twenty Three New Zealand Dollars and Zero Cents Only`],
...
const testFractionStyleEnNZ: [number, string][] = [
...
describe("Test Floats with options = { decimalStyle: 'fraction' }", () => {
  test.concurrent.each(testFractionStyleEnNZ)('convert %d => %s', (input, expected) => {
