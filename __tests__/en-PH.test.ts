...
describe('Test with options = { currency: true, includeZeroFractional: true }', () => {
  const testIncludeZeroFractional: [number | string, string][] = [
    [123, `One Hundred Twenty Three Pesos Only`],
    ['123', `One Hundred Twenty Three Pesos Only`],
    ['123.0', `One Hundred Twenty Three Pesos And Zero Centavos Only`],
    ['123.00', `One Hundred Twenty Three Pesos And Zero Centavos Only`],
    ['0.00', `Zero Pesos And Zero Centavos Only`],
    ['-123.00', `Minus One Hundred Twenty Three Pesos And Zero Centavos Only`],
...
describe('Test Zero Variants', () => {
  ...
  test('convert 0 with currency => Zero Pesos Only', () => {
    expect(toWords.convert(0, { currency: true })).toBe('Zero Pesos Only');
  });
});
...
const testFractionStyleEnPH: [number, string][] = [
...
describe("Test Floats with options = { decimalStyle: 'fraction' }", () => {
  test.concurrent.each(testFractionStyleEnPH)('convert %d => %s', (input, expected) => {
