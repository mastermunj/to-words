...
import enSg from '../src/locales/en-SG.js';
import {
  ToWords as LocaleToWords,
  toWords as localeToWords,
  toOrdinal as localeToOrdinal,
  toCurrency as localeToCurrency,
} from '../src/locales/en-SG.js';

const localeCode = 'en-SG';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toWords.getLocaleClass()).toBe(enSg);
  });
...
describe('Test with options = { currency: true, includeZeroFractional: true }', () => {
  const testIncludeZeroFractional: [number | string, string][] = [
    [123, `One Hundred Twenty Three Dollars Only`],
    ['123', `One Hundred Twenty Three Dollars Only`],
    ['123.0', `One Hundred Twenty Three Dollars And Zero Cents Only`],
    ['123.00', `One Hundred Twenty Three Dollars And Zero Cents Only`],
    ['0.00', `Zero Dollars And Zero Cents Only`],
    ['-123.00', `Minus One Hundred Twenty Three Dollars And Zero Cents Only`],
...
const testFloatsWithCurrency: [number, string][] = [
  ...
  [0.01, `Zero Dollars And One Cent Only`],
...
describe('Test Zero Variants', () => {
  ...
  test('convert 0 with currency => Zero Dollars Only', () => {
...
const testFractionStyleEnSG: [number, string][] = [
...
describe("Test Floats with options = { decimalStyle: 'fraction' }", () => {
  test.concurrent.each(testFractionStyleEnSG)('convert %d => %s', (input, expected) => {
