...
describe('Test with options = { currency: true, includeZeroFractional: true }', () => {
  const testIncludeZeroFractional: [number | string, string][] = [
    [123, `Ciento Veintitrés Euros`],
    ['123', `Ciento Veintitrés Euros`],
    ['123.0', `Ciento Veintitrés Euros Y Cero Céntimos`],
    ['123.00', `Ciento Veintitrés Euros Y Cero Céntimos`],
    ['0.00', `Cero Euros Y Cero Céntimos`],
    ['-123.00', `Menos Ciento Veintitrés Euros Y Cero Céntimos`],
...
const testFractionStyleEsES: [number, string][] = [
...
describe("Test Floats with options = { decimalStyle: 'fraction' }", () => {
  test.concurrent.each(testFractionStyleEsES)('convert %d => %s', (input, expected) => {
