...
describe('Test with options = { currency: true, includeZeroFractional: true }', () => {
  const testIncludeZeroFractional: [number | string, string][] = [
    [123, `Ciento Veintitrés Pesos Mexicanos`],
    ['123', `Ciento Veintitrés Pesos Mexicanos`],
    ['123.0', `Ciento Veintitrés Pesos Mexicanos Y Cero Centavos`],
    ['123.00', `Ciento Veintitrés Pesos Mexicanos Y Cero Centavos`],
    ['0.00', `Cero Pesos Mexicanos Y Cero Centavos`],
    ['-123.00', `Menos Ciento Veintitrés Pesos Mexicanos Y Cero Centavos`],
...
describe('Test Zero Variants', () => {
  ...
  test('convert 0 with currency => Cero Pesos Mexicanos', () => {
    expect(toWords.convert(0, { currency: true })).toBe('Cero Pesos Mexicanos');
  });
});
...
const testFractionStyleEsMX: [number, string][] = [
...
describe("Test Floats with options = { decimalStyle: 'fraction' }", () => {
  test.concurrent.each(testFractionStyleEsMX)('convert %d => %s', (input, expected) => {
