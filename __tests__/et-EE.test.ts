...
import etEe from '../src/locales/et-EE.js';
import {
  ToWords as LocaleToWords,
  toWords as localeToWords,
  toOrdinal as localeToOrdinal,
  toCurrency as localeToCurrency,
} from '../src/locales/et-EE.js';

const localeCode = 'et-EE';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toWords.getLocaleClass()).toBe(etEe);
  });
...
describe('Test with options = { currency: true, includeZeroFractional: true }', () => {
  const testIncludeZeroFractional: [number | string, string][] = [
    [123, `Ainult Sada Kakskümmend Kolm Eurot`],
    ['123', `Ainult Sada Kakskümmend Kolm Eurot`],
    ['123.0', `Ainult Sada Kakskümmend Kolm Eurot Ja Null Senti`],
    ['123.00', `Ainult Sada Kakskümmend Kolm Eurot Ja Null Senti`],
    ['0.00', `Ainult Null Eurot Ja Null Senti`],
    ['-123.00', `Ainult Miinus Sada Kakskümmend Kolm Eurot Ja Null Senti`],
    ['37.68', `Ainult Kolmkümmend Seitse Eurot Ja Kuuskümmend Kaheksa Senti`],
  ];
...
describe('Test Zero Variants', () => {
  ...
  test('convert 0.0 => Null', () => {
    expect(toWords.convert(0.0)).toBe('Null');
  });

  test('convert 0n => Null', () => {
  ...
  test('convert 0 with currency => Ainult Null Eurot', () => {
    expect(toWords.convert(0, { currency: true })).toBe('Ainult Null Eurot');
  });
});
