...
describe('Test with options = { currency: true, includeZeroFractional: true }', () => {
  const testIncludeZeroFractional: [number | string, string][] = [
    [123, `Cent Vingt-Trois Dirhams`],
    ['123', `Cent Vingt-Trois Dirhams`],
    ['123.0', `Cent Vingt-Trois Dirhams Et Zéro Centimes`],
    ['123.00', `Cent Vingt-Trois Dirhams Et Zéro Centimes`],
    ['0.00', `Zéro Dirhams Et Zéro Centimes`],
    ['-123.00', `Moins Cent Vingt-Trois Dirhams Et Zéro Centimes`],
...
const testFractionStyleFrMA: [number, string][] = [
...
describe("Test Floats with options = { decimalStyle: 'fraction' }", () => {
  test.concurrent.each(testFractionStyleFrMA)('convert %d => %s', (input, expected) => {
