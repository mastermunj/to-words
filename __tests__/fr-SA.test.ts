...
describe('Test with options = { currency: true, includeZeroFractional: true }', () => {
  const testIncludeZeroFractional: [number | string, string][] = [
    [123, `Cent Vingt-Trois Riyals`],
    ['123', `Cent Vingt-Trois Riyals`],
    ['123.0', `Cent Vingt-Trois Riyals Et Zéro Halalas`],
    ['123.00', `Cent Vingt-Trois Riyals Et Zéro Halalas`],
    ['0.00', `Zéro Riyals Et Zéro Halalas`],
    ['-123.00', `Moins Cent Vingt-Trois Riyals Et Zéro Halalas`],
...
describe('Zero Variants', () => {
  ...
  test('convert 0 with currency => Zéro Riyals', () => {
    expect(toWords.convert(0, { currency: true })).toBe('Zéro Riyals');
  });
});
...
const testFractionStyleFrSA: [number, string][] = [
...
describe("Test Floats with options = { decimalStyle: 'fraction' }", () => {
  test.concurrent.each(testFractionStyleFrSA)('convert %d => %s', (input, expected) => {
