...
describe('Test with options = { currency: true, includeZeroFractional: true }', () => {
  const testIncludeZeroFractional: [number | string, string][] = [
    [123, `Seratus Dua Puluh Tiga Ringgit Sahaja`],
    ['123', `Seratus Dua Puluh Tiga Ringgit Sahaja`],
    ['123.0', `Seratus Dua Puluh Tiga Ringgit Dan Sifar Sen Sahaja`],
    ['123.00', `Seratus Dua Puluh Tiga Ringgit Dan Sifar Sen Sahaja`],
    ['0.00', `Sifar Ringgit Dan Sifar Sen Sahaja`],
    ['-123.00', `Minus Seratus Dua Puluh Tiga Ringgit Dan Sifar Sen Sahaja`],
