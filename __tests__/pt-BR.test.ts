...
describe('Test with options = { currency: true, includeZeroFractional: true }', () => {
  const testIncludeZeroFractional: [number | string, string][] = [
    [123, `Cento E Vinte E Três Reais`],
    ['123', `Cento E Vinte E Três Reais`],
    ['123.0', `Cento E Vinte E Três Reais E Zero Centavos`],
    ['123.00', `Cento E Vinte E Três Reais E Zero Centavos`],
    ['0.00', `Zero Reais E Zero Centavos`],
    ['-123.00', `Menos Cento E Vinte E Três Reais E Zero Centavos`],
...
const testFractionStylePtBR: [number, string][] = [
  [1.1, 'Um E Um Décimo'],
...
describe("Test Floats with options = { decimalStyle: 'fraction' }", () => {
  test.concurrent.each(testFractionStylePtBR)('convert %d => %s', (input, expected) => {
