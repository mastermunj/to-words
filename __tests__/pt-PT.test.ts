...
describe('Test with options = { currency: true, includeZeroFractional: true }', () => {
  const testIncludeZeroFractional: [number | string, string][] = [
    [123, `Cento E Vinte E Três Euros`],
    ['123', `Cento E Vinte E Três Euros`],
    ['123.0', `Cento E Vinte E Três Euros E Zero Cêntimos`],
    ['123.00', `Cento E Vinte E Três Euros E Zero Cêntimos`],
    ['0.00', `Zero Euros E Zero Cêntimos`],
    ['-123.00', `Menos Cento E Vinte E Três Euros E Zero Cêntimos`],
...
const testFractionStylePtPT: [number, string][] = [
  [1.1, 'Um E Um Décimo'],
...
describe("Test Floats with options = { decimalStyle: 'fraction' }", () => {
  test.concurrent.each(testFractionStylePtPT)('convert %d => %s', (input, expected) => {
