...
class ToWords {
  ...
  convert(number, options = {}) {
    ...
    if (options.currency) {
      ...
      const ignoreZero =
        ...
        (((_a = locale.options) === null || _a === void 0
          ? void 0
          : _a.ignoreZeroInDecimals) &&
          number !== 0);
        ...
        const decimalLengthWord =
          (_b =
            locale === null || locale === void 0
              ? void 0
              : locale.decimalLengthWordMapping) === null || _b === void 0
            ? void 0
            : _b[split[1].length];
      ...
      const ignoreZero =
        isNumberZero &&
        ((_c = locale.options) === null || _c === void 0
          ? void 0
          : _c.ignoreZeroInDecimals);
      const words =
        isFloat && ignoreZero
          ? ''
      ...
      if (isFloat) {
        const decimalLengthWord =
          (_d =
            locale === null || locale === void 0
              ? void 0
              : locale.decimalLengthWordMapping) === null || _d === void 0
            ? void 0
            : _d[split[1].length];
  ...
  convertInternal(number, options = {}) {
    ...
    const locale = this.getLocale();
    const splitWord = (
      (_a = locale.options) === null || _a === void 0 ? void 0 : _a.splitWord
    )
      ? `${
          (_b = locale.options) === null || _b === void 0
            ? void 0
            : _b.splitWord
        } `
      : '';
