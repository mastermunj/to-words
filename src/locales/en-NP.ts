...
export default class Locale implements LocaleInterface {
  public config: LocaleConfig = {
    ...
    numberWordsMapping: [
      { number: 10n ** 17n, value: 'Shankh' },
      { number: 10n ** 15n, value: 'Padma' },
      { number: 10n ** 13n, value: 'Neel' },
      { number: 10n ** 11n, value: 'Kharab' },
      { number: 10n ** 9n, value: 'Arab' },
 ...
 *
 * @example
 * import { ToWords } from 'to-words/en-NP';
