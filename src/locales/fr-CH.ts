...
export default class Locale implements LocaleInterface {
  public config: LocaleConfig = {
    ...
    numberWordsMapping: [
      ...
      { number: 89, value: 'Huitante-Neuf' },
      { number: 88, value: 'Huitante-Huit' },
      { number: 87, value: 'Huitante-Sept' },
      { number: 86, value: 'Huitante-Six' },
      { number: 85, value: 'Huitante-Cinq' },
      { number: 84, value: 'Huitante-Quatre' },
      { number: 83, value: 'Huitante-Trois' },
      { number: 82, value: 'Huitante-Deux' },
      { number: 81, value: 'Huitante Et Un' },
