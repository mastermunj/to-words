...
export default class Locale implements LocaleInterface {
  public config: LocaleConfig = {
    ...
    numberWordsMapping: [
      { number: 10n ** 17n, value: 'ಶಂಖ' },
      { number: 10n ** 15n, value: 'ಪದ್ಮ' },
      { number: 10n ** 13n, value: 'ನೀಲ್' },
      { number: 10n ** 11n, value: 'ಖರಬ್' },
      { number: 10n ** 9n, value: 'ಅರಬ್' },
 ...
 *
 * @example
 * import { ToWords } from 'to-words/kn-IN';
